...
ordersDF1 = ordersDF.select("invoicedate", "stockcode", "quantity", "storenumber")

ordersDF2 = ordersDF1.withColumnRenamed("stockcode","item_id").withColumnRenamed("quantity","demand").withColumnRenamed("storenumber","location").withColumnRenamed("invoicedate","timestamp")
...
# add new column for process date
ordersDF3 = ordersDF2.withColumn('processeddate','timestamp')
